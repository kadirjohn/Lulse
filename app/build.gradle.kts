...
android {
    ...
    // WearableListenerService BIND_LISTENER intent-filter deprecated uyarısı —
    // Wear OS hâlâ service keşfi için kullanıyor. Watch6 integration.
    lint {
        abortOnError = false
